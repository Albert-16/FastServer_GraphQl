...
// Show sample data
using var cmd4 = new NpgsqlCommand("SELECT \"fastserver_log_id\", \"fastserver_microservice_name\", \"fastserver_log_method_name\" FROM \"FastServer_LogServices_Header\" LIMIT 3", conn);
using var reader = await cmd4.ExecuteReaderAsync();

Console.WriteLine("\nPrimeros 3 registros de Headers:");
