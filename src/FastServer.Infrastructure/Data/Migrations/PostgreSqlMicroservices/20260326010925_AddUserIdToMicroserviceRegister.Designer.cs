...
namespace FastServer.Infrastructure.Data.Migrations.PostgreSqlMicroservices
{
    ...
    [Migration("20260326010925_AddUserIdToMicroserviceRegister")]
    partial class AddUserIdToMicroserviceRegister
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FastServer.Domain.Entities.Microservices.MicroserviceRegister", b =>
                {
                    ...
                    b.Property<Guid?>("FastServerUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("fastserver_user_id");
            ...
            modelBuilder.Entity("FastServer.Domain.Entities.Microservices.MicroserviceRegister", b =>
                {
                    b.HasOne("FastServer.Domain.Entities.Microservices.User", "User")
                        ...
                        .HasForeignKey("FastServerUserId")
                        .OnDelete(DeleteBehavior.Restrict);
