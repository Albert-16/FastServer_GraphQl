        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FastServer_LogMicroservice_FastServer_LogServices_Header_fa~",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    fastserver_log_id = table.Column<long>(type: "bigint", nullable: false),
                    fastserver_no = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FastServer_LogServices_Content_FastServer_LogServices_Heade~",
                        column: x => x.fastserver_log_id,
                        principalTable: "FastServer_LogServices_Header",
                        principalColumn: "fastserver_log_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FastServer_LogMicroservice_Historico_FastServer_LogServices~",
                        column: x => x.fastserver_log_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FastServer_LogServices_Content_Historico_FastServer_LogServ~",
                        column: x => x.fastserver_log_id,
                        principalTable: "FastServer_LogServices_Header_Historico",
                        principalColumn: "fastserver_log_id",
                        onDelete: ReferentialAction.Cascade);
